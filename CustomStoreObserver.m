...
-(void) provideContent:(NSString *)productIdentifier{
	...
	// From Free
	if ([productIdentifier isEqualToString:@"com.LearnersCloud.iEvaluatorforIpad.biology.250"]) {
		
		[[NSUserDefaults standardUserDefaults] setObject:@"2" forKey:@"AccessLevel"];
	
	}
		 
	else if ([productIdentifier isEqualToString:@"com.LearnersCloud.iEvaluatorforIpad.biology.500"])
	...
	else if ([productIdentifier isEqualToString:@"com.LearnersCloud.iEvaluatorforIpad.biology.750"])
	...
	else if ([productIdentifier isEqualToString:@"com.LearnersCloud.iEvaluatorforIpad.biology.250To500"])
	{
	...
	else if ([productIdentifier isEqualToString:@"com.LearnersCloud.iEvaluatorforIpad.biology.250To750"])
	{
	...
	else if ([productIdentifier isEqualToString:@"com.LearnersCloud.iEvaluatorforIpad.biology.500To750"])
	{
	...
	else if ([productIdentifier isEqualToString:@"com.LearnersCloud.iEvaluatorforIpad.biology.500To1040"])
	{
	...
	else if ([productIdentifier isEqualToString:@"com.LearnersCloud.iEvaluatorforIpad.biology.750To1040"])
	{
