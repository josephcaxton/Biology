...
-(IBAction)ReportProblem:(id)sender{
	...
	[SendMailcontroller setSubject:[NSString stringWithFormat:@"Ref %@ problem biology question detected on IPad",[[NSString stringWithFormat:@"%@",QItem_View.Question] stringByDeletingPathExtension]]];
...
- (void)viewDidUnload {
   ...
   /* FileListTable = nil;
    AnswerObjects = nil;
    CorrectAnswers = nil;
    MultichoiceAnswers = nil;
    SelectedAnswers = nil;
    AnswerCounter = nil;
    HighlightedAnswers = nil;
    Continue = nil;
    self.view = nil; */
